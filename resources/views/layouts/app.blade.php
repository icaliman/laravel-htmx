...
<head>
    ...
    <!-- Follow the OS colour scheme (daisyUI themes are keyed on data-theme) -->
    <script>
        (function () {
...
<body class="min-h-screen bg-base-200 text-base-content antialiased">
    <main class="mx-auto flex w-full max-w-lg flex-col px-6 py-16 lg:py-24">
        <header class="flex items-center justify-center gap-5">
            <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg"
            class="h-16 w-auto shrink-0" aria-label="Laravel">
                <path
            ...
            <span class="text-4xl font-light text-base-content/40">+</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0.00 0.00 379.00 102.00" class="h-12 w-auto text-base-content"
            aria-label="htmx">
                <path fill="#3465a4"
